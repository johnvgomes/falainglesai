    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fade-in">
      <div className="bg-zinc-900 border border-zinc-700 max-w-lg w-full rounded-3xl p-6 sm:p-8 shadow-2xl relative">
        ...
        <div className="space-y-3.5 text-sm text-zinc-300 leading-relaxed max-h-[60vh] overflow-y-auto pr-2">
          ...
          <p>
            Decidi transformar essa dor em engenharia: construí o <strong>FalaIngles.ai</strong> usando Clean Architecture, .NET 9, WebRTC e React para que qualquer pessoa possa treinar 10 minutos por dia sem medo de errar e de forma <strong>100% gratuita</strong>.
          </p>
